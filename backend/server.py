...
PROJECTS_DATA: List[Project] = [
    ...
    Project(
        id="vidyaguide",
        name="VidyaGuide AI Agent",
        description="Personalized AI learning companion that adapts to each learner's pace, offering curated study plans, quizzes, and contextual explanations in real time.",
        language="TypeScript",
        html_url="https://github.com/SuhasReturn/VidyaGuide_Ai_Agent",
        homepage="https://vidya-guide-ai-agent.vercel.app",
        stars=0,
        tags=["AI Agent", "EdTech", "LLM"],
        accent="secondary",
    ),
    Project(
        id="neurodiverse",
        name="Neuro-Diverse Adaptive AI",
        description="Adaptive interface engine that reshapes web experiences for neurodiverse users — dyslexia-friendly typography, ADHD focus modes, and cognitive load tuning.",
        language="JavaScript",
        html_url="https://github.com/SuhasReturn/Neuro_Diverse_Adaptive_Ai",
        homepage="https://neuro-diverse-adaptive-ai.vercel.app",
        stars=0,
    ...
    Project(
        ...
        description="Context-aware conversational agent with layered memory and intent modeling, built to hold long-form domain-specific discussions.",
        language="JavaScript",
        html_url="https://github.com/SuhasReturn/Cognitive_Chatbot",
        stars=0,
        tags=["Chatbot", "NLP", "AI"],
        accent="accent",
    ),
    ...
    Project(
        id="visualfatigue",
        name="Visual Fatigue Analyzer",
        description="Python-based eye-strain monitor that uses blink rate, gaze patterns, and screen exposure heuristics to alert users before fatigue peaks.",
        language="Python",
        html_url="https://github.com/SuhasReturn/visual_fatigue",
        stars=0,
        tags=["Python", "Health Tech", "CV"],
        accent="primary",
    ),
]
